...
\begin{itemize}
  ...
  \item Detail of each hardware: \href[page=5]{./datasheet/Fire Bird V ATMEGA2560 Hardware Manual 2010-12-21.pdf}{Hardware manual for the firebird V}, \href{http://www.nex-robotics.com/products/fire-bird-v-robots/fire-bird-v-atmega2560-robotic-research-platform.html}{Vendor link (nex robotics)},
\end{itemize}
