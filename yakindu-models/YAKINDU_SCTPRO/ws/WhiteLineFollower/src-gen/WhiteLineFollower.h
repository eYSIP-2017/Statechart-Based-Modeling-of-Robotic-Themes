...
typedef enum
{
	WhiteLineFollower_White_Line_Follower_OnLine,
	WhiteLineFollower_White_Line_Follower_LeftOfLine,
	WhiteLineFollower_White_Line_Follower_RightOfLine,
	WhiteLineFollower_White_Line_Follower_OutOfLine,
