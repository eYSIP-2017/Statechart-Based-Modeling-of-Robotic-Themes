...
typedef enum
{
	WhiteLineFollower_LineFollower_LineFollowerOn,
	WhiteLineFollower_LineFollower_LineFollowerOn_r1_AllSensorDetectWhite,
	WhiteLineFollower_LineFollower_LineFollowerOn_r1_Composite_RightSensorOnLine_LeftSensorOnLine_CenterSensorOnLine,
	WhiteLineFollower_LineFollower_LineFollowerOn_r1_Composite_RightSensorOnLine_LeftSensorOnLine_CenterSensorOnLine_inner_region_RightSensorOnLine,
	WhiteLineFollower_LineFollower_LineFollowerOn_r1_Composite_RightSensorOnLine_LeftSensorOnLine_CenterSensorOnLine_inner_region_LeftSensorOnLine,
	WhiteLineFollower_LineFollower_LineFollowerOn_r1_Composite_RightSensorOnLine_LeftSensorOnLine_CenterSensorOnLine_inner_region_CenterSensorOnLine,
	WhiteLineFollower_last_state
} WhiteLineFollowerStates;

/*! Type definition of the data structure for the WhiteLineFollowerInternal interface scope. */
typedef struct
{
	sc_boolean StartLineFollower_raised;
	sc_boolean StopLineFollower_raised;
} WhiteLineFollowerInternal;
...
typedef struct
{
	...
	WhiteLineFollowerInternal internal;
...
extern sc_boolean whiteLineFollowerIfaceInput_get_isnode(const WhiteLineFollower* handle);
/*! Sets the value of the variable 'isnode' that is defined in the interface scope 'Input'. */ 
extern void whiteLineFollowerIfaceInput_set_isnode(WhiteLineFollower* handle, sc_boolean value);
